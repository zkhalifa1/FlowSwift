...
import { extractBlocksFromTemplate, saveBlocksToReport } from "@/services/templateService";
...
/**
 * Report Block Editor - Edit {{{blocks}}} within a generated report
 */
export default function ReportBlockEditor({ report, onClose, onSave }) {
